...
# # Build
./autogen.sh
export BDB_PREFIX=/$1/bitcoin-installation-script/bth-1/db4
./configure --prefix=/$1/bitcoin-installation-script/bth-1/depends/x86_64-pc-linux-gnu/ BDB_LIBS="-L${BDB_PREFIX}/lib -ldb_cxx-5.3" BDB_CFLAGS="-I${BDB_PREFIX}/include" --enable-cxx --disable-shared --with-pic
make
